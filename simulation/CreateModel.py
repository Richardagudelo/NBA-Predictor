...
def fillDivisionsTeams():
	...
	for i in range(0, len(equipos)):
		...
		if equipo[1] in {1610612737, 1610612748, 1610612753, 1610612764, 1610612766}:
			southeast.add_team(Team(equipo[1], equipo[0], equipo[3], equipo[4], equipo[5]))
		elif equipo[1] in {1610612738, 1610612751, 1610612752, 1610612755, 1610612761}:
			atlantic.add_team(Team(equipo[1], equipo[0], equipo[3], equipo[4], equipo[5]))
		elif equipo[1] in {1610612739, 1610612741, 1610612749, 1610612754, 1610612765}:
			central.add_team(Team(equipo[1], equipo[0], equipo[3], equipo[4], equipo[5]))
		elif equipo[1] in {1610612740, 1610612742, 1610612745, 1610612759, 1610612763}:
			southwest.add_team(Team(equipo[1], equipo[0], equipo[3], equipo[4], equipo[5]))
		elif equipo[1] in {1610612743, 1610612750, 1610612757, 1610612760, 1610612762}:
			northwest.add_team(Team(equipo[1], equipo[0], equipo[3], equipo[4], equipo[5]))
		else:
			pacific.add_team(Team(equipo[1], equipo[0], equipo[3], equipo[4], equipo[5]))
